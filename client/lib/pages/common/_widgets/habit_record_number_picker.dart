...
class _NormalHabitRecordChipList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget normalValChip = ActionChip(
      avatar: FittedBox(child: Icon(MdiIcons.checkCircle)),
      label: Text(
    ...
    final Widget zeroValChip = ActionChip(
      avatar: FittedBox(child: Icon(MdiIcons.closeCircle)),
      label: l10n != null
    ...
    Widget? buildExtraValChip() {
      ...
      return ActionChip(
        avatar: FittedBox(child: Icon(MdiIcons.checkUnderlineCircle)),
        label: Text(
